...
Ubuntu 20.04, 64 Bit, Linux-Kernel 5.4.0. Kompiliert wurde mit GCC 8.1.0 mit der Option - 03. \par
Die erste Implementierung nutzt eine herkömmliche Matrix und alle naiven Implementierungen der Arithmetik von Big-Nums, 
die zweite nutzt kompakte Matrizen, die die Anzahl der Rechnungen minimiert, Addition und Subtraktion in SIMD und die Karazuba-Multiplikation. Die dritte gleicht der zweiten, nur mit dem Unterschied, dass statt der 
