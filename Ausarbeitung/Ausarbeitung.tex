...
\begin{figure} \label{fig:performanz-matrix}
\centering
\begin{subfigure}{.5\textwidth} \label{subfig:matrixexp}
      \centering
...
\end{subfigure}%
\begin{subfigure}{.5\textwidth} \label{subfig:matrixmul}
      \centering
\begin{tikzpicture}
\begin{axis}[width=1.1\textwidth]
...
\end{subfigure}
\caption{Performanz einzelner Operationen}
\end{figure}
...
Ubuntu 20.04, 64 Bit, Linux-Kernel 5.4.0 ausgeführt. Kompiliert wurde mit der Option -01 mit GCC 8.1.0. \par
