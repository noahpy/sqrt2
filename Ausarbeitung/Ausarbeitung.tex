...
\begin{figure}[h] 
\centering
\subfloat[Lena: Photoshop-Output]{{\includegraphics[scale=0.2]{graphiken/division-example.png} }}
\qquad
\subfloat[Lena: Code-Output]{{\includegraphics[scale=0.2]{graphiken/division-example.png} }}
